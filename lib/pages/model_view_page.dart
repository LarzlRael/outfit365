...
class _ModelViewPageState extends State<ModelViewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final outfitCreatorProvider = context.read<OutfitCreatorProvider>();

    final topPosition = (outfitCreatorProvider.state.images.length == 1)
        ? size.height * 0.30
        : size.height * 0.12;
      ...
      child: Scaffold(
        body: SafeArea(
          child: SizedBox(
            ...
            child: Stack(
              children: [
                ModelView(cloth: outfitCreatorProvider.state.currentCloth),
                Positioned(
                  top: 15,
                  left: 15,
                  child: IconButton(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: outfitCreatorProvider.state.images.map((e) {
                          var index =
                              outfitCreatorProvider.state.images.indexOf(e);
